...
function App(): React.JSX.Element {
  ...
  const [isDarkMode, setIsDarkMode] = React.useState(() => {
    try {
      const stored = localStorage.getItem(typedStrings.localStorage.darkMode);
  ...
  const usePerformanceMonitor = (): void => {
    React.useEffect(() => {
      if ("performance" in window) {
        ...
        observer.observe({
          entryTypes: [typedStrings.performanceEntryTypes.navigation],
        });
      }
    }, []);
  };
      ...
      >
        <button
          ...
          aria-label={`Switch to ${
            isDarkMode
              ? typedStrings.theme.toggle.switchToLight
              : typedStrings.theme.toggle.switchToDark
          } mode`}
            ...
            {socialLinks.map((link, index) => {
              ...
              return (
                <a
                  ...
                  aria-label={
                    link.name === typedStrings.social.github.name
                      ? typedStrings.social.github.ariaLabel
